...
struct Benchmark {
    ...
    const int benchNumber = 52;
    string benchmarkfens[52] = {"r3k2r/2pb1ppp/2pp1q2/p7/1nP1B3/1P2P3/P2N1PPP/R2QK2R w KQkq a6 0 14",
    ...
    void benchmark(int depth, int benchTime) {
        long long nodes = 0;
